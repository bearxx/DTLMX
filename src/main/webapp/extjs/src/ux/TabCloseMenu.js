...
Ext.define('Ext.ux.TabCloseMenu', {
    ...
    /**
     * @cfg {String} closeTabIconCls The iconCls for closing the current tab.
     */
    ...
    /**
     * @cfg {String} closeOthersTabsIconCls The iconCls for closing all tabs
    ...
    /**
     * @cfg {String} closeAllTabsIconCls The iconCls for closing all tabs.
     *      except.
     */
